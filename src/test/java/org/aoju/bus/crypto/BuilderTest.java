...
public class BuilderTest {
    ...
    public void testAll() {
        ...
        /** DES 加解密 */
        key = Base64Encoder.encodeBuffer(Builder.generateKey(Algorithm.DES).getEncoded());
        ...
        key = Base64Encoder.encodeBuffer(pair.getPrivate().getEncoded()) + ","
                + Base64Encoder.encodeBuffer(pair.getPublic().getEncoded());
