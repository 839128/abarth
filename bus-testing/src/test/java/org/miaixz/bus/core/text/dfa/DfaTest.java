...
public class DfaTest {
    ...
    public void matchAllTest() {
        ...
        Assertions.assertEquals(matchAll, ListKit.of("大", "土^豆", "刚出锅"));
    }
    ...
    public void densityMatchTest() {
        ...
        Assertions.assertEquals(matchAll, ListKit.of("大", "土^豆", "刚出锅", "出锅"));
    }
    ...
    public void greedMatchTest() {
        ...
        Assertions.assertEquals(ListKit.of("大土^豆", "刚出锅"), matchAll);
    }
    ...
    public void densityAndGreedMatchTest() {
        ...
        Assertions.assertEquals(ListKit.of("大土^豆", "土^豆", "刚出锅", "出锅"), matchAll);
    ...
    public void stopWordTest() {
        ...
        Assertions.assertEquals(all, ListKit.of("t-io"));
    }
...
//		Assertions.assertTrue(tree.matchAll("黑大衣").contains("黑"));
    ...
    void flattenTest() {
        final WordTree wordTree = new WordTree();
        final List<String> list = Arrays.asList("阿帕奇", "阿超", "Bus", "Buxyz");
