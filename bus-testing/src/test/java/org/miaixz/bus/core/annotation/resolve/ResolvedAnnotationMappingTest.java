...
public class ResolvedAnnotationMappingTest {
    ...
    public void testGetAttributeIndex() {
        ...
        Assertions.assertEquals(Normal.__1, mapping.getAttributeIndex("value", Void.class));
        Assertions.assertEquals(Normal.__1, mapping.getAttributeIndex("nonexistent", Void.class));
    }
