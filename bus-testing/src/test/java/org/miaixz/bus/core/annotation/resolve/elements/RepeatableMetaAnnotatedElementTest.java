...
import org.miaixz.bus.core.annotation.resolve.GenericAnnotationMapping;
...
public class RepeatableMetaAnnotatedElementTest {
    ...
    public void testGetAnnotations() {
        ...
        final Map<Class<? extends Annotation>, Integer> countMap = IteratorKit.countMap(annotationTypes.iterator());
