...
public class ConvertTest {
    ...
    public void toStrTest() {
        ...
        final String aStr = Convert.toString(a);
        Assertions.assertEquals("1", aStr);
        final String bStr = Convert.toString(b);
    ...
    public void toStrTest4() {
        // 被当作八进制
        @SuppressWarnings("OctalInteger") final String result = Convert.toString(001200);
    ...
    public void toStrTest5() {
        ...
        final String aResult = Convert.toString(a, aDefaultValue);
        Assertions.assertEquals(aResult, a);

        // 被转化的对象为null，返回默认值
        final String b = null;
        final String bDefaultValue = "bDefault";
        final String bResult = Convert.toString(b, bDefaultValue);
        ...
        final String cResult = Convert.toString(c, cDefaultValue);
    ...
    public void toListTest() {
        ...
        final String str = Convert.toString(list);
    ...
    public void numberToByteArrayTest() {
        ...
        Assertions.assertArrayEquals(ByteKit.toBytes(12L), bytes);
    }
    ...
    public void toClassTest() {
        final Class<?> convert = Convert.convert(Class.class, "org.miaixz.bus.core.convert.ConvertTest.Product");
    ...
    public void toSetTest() {
        final Set<Integer> result = Convert.convert(new TypeReference<>() {
        }, "1,2,3");
        Assertions.assertEquals(SetKit.of(1, 2, 3), result);
    }
    ...
    public void toSqlDateTest() {
        final java.sql.Date date = Convert.convert(java.sql.Date.class, DateKit.parse("2021-07-28"));
    ...
    public void toFloatTest() {
        ...
        final byte[] value = HexKit.decode(hex2);
