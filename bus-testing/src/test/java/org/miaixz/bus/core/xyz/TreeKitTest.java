...
public class TreeKitTest {
    ...
    // 模拟数据
    static List<TreeNode<String>> nodeList = ListKit.of();
    ...
    public void sampleTreeTest() {
        final List<MapTree<String>> treeList = TreeKit.build(nodeList, "0");
...
//			Console.log(tree);
    ...
    public void treeTest() {
        ...
        //配置
        final NodeConfig treeNodeConfig = new NodeConfig();
        // 自定义属性名 都要默认值的
        ...
        //转换器
        final List<MapTree<String>> treeNodes = TreeKit.build(nodeList, "0", treeNodeConfig,
                (treeNode, tree) -> {
    ...
    public void walkTest() {
        ...
        final MapTree<String> tree = TreeKit.buildSingle(nodeList, "0");
