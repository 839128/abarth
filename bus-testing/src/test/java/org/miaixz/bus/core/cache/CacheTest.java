...
public class CacheTest {
    ...
    public void fifoCacheTest() {
        final Cache<String, String> fifoCache = CacheKit.newFIFOCache(3);
        ...
        fifoCache.put("key1", "value1", Units.SECOND.getMillis() * 3);
        fifoCache.put("key2", "value2", Units.SECOND.getMillis() * 3);
        fifoCache.put("key3", "value3", Units.SECOND.getMillis() * 3);
        fifoCache.put("key4", "value4", Units.SECOND.getMillis() * 3);
    ...
    public void fifoCacheCapacityTest() {
        final Cache<String, String> fifoCache = CacheKit.newFIFOCache(100);
        for (int i = 0; i < RandomKit.randomInt(100, 1000); i++) {
    ...
    public void lfuCacheTest() {
        final Cache<String, String> lfuCache = CacheKit.newLFUCache(3);
        lfuCache.put("key1", "value1", Units.SECOND.getMillis() * 3);
        //使用次数+1
        lfuCache.get("key1");
        lfuCache.put("key2", "value2", Units.SECOND.getMillis() * 3);
        lfuCache.put("key3", "value3", Units.SECOND.getMillis() * 3);
        lfuCache.put("key4", "value4", Units.SECOND.getMillis() * 3);
    ...
    public void lruCacheTest() {
        final Cache<String, String> lruCache = CacheKit.newLRUCache(3);
        //通过实例化对象创建
//		LRUCache<String, String> lruCache = new LRUCache<String, String>(3);
        lruCache.put("key1", "value1", Units.SECOND.getMillis() * 3);
        lruCache.put("key2", "value2", Units.SECOND.getMillis() * 3);
        lruCache.put("key3", "value3", Units.SECOND.getMillis() * 3);
        //使用时间推近
        lruCache.get("key1");
        lruCache.put("key4", "value4", Units.SECOND.getMillis() * 3);
    ...
    public void timedCacheTest() {
        final TimedCache<String, String> timedCache = CacheKit.newTimedCache(4);
//		TimedCache<String, String> timedCache = new TimedCache<String, String>(Units.SECOND.getMillis() * 3);
        timedCache.put("key1", "value1", 1);//1毫秒过期
        timedCache.put("key2", "value2", Units.SECOND.getMillis() * 5);//5秒过期
