...
public class LambdaFactoryTest {
    ...
    public void testMethodNotMatch() {
        try {
            ...
            Assertions.assertSame(LambdaConversionException.class, e.getCause());
        }
    }
    ...
    class PerformanceTest {
        ...
        public static Collection<Integer> parameters() {
            return ListKit.of(1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000);
        }
        ...
        public void lambdaGetPerformanceTest() {
            ...
            final MethodHandle getByMh = LookupKit.findMethod(Something.class, "getId", MethodType.methodType(Long.class));
        ...
        public void testConstructor() {
            final Constructor<Something> constructor = ((SupplierX<Constructor<Something>>) Something.class::getConstructor).get();
        ...
        public void lambdaSetPerformanceTest() {
            ...
            final MethodHandle setByMh = LookupKit.findMethod(Something.class, "setName", MethodType.methodType(Void.TYPE, String.class));
