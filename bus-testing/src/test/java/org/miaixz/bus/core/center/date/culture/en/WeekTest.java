...
public class WeekTest {
    ...
    public void toChineseTest() {
        Assertions.assertEquals("周一", Week.MONDAY.getName("周"));
        Assertions.assertEquals("星期一", Week.MONDAY.getName("星期"));
        Assertions.assertEquals("星期二", Week.TUESDAY.getName("星期"));
        Assertions.assertEquals("星期三", Week.WEDNESDAY.getName("星期"));
        Assertions.assertEquals("星期四", Week.THURSDAY.getName("星期"));
        Assertions.assertEquals("星期五", Week.FRIDAY.getName("星期"));
        Assertions.assertEquals("星期六", Week.SATURDAY.getName("星期"));
        Assertions.assertEquals("星期日", Week.SUNDAY.getName("星期"));
        Assertions.assertEquals("星期一", Week.MONDAY.getName());
    }
