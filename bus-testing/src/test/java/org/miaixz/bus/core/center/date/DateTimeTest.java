...
public class DateTimeTest {
    ...
    public void datetimeTest() {
        final DateTime dateTime = new DateTime("2017-01-05 12:34:23", Formatter.NORM_DATETIME_FORMAT);
    ...
    public void quarterTest() {
        DateTime dateTime = new DateTime("2017-01-05 12:34:23", Formatter.NORM_DATETIME_FORMAT);
        Quarter quarter = dateTime.quarterEnum();
        Assertions.assertEquals(Quarter.Q1, quarter);

        dateTime = new DateTime("2017-04-05 12:34:23", Formatter.NORM_DATETIME_FORMAT);
        quarter = dateTime.quarterEnum();
        Assertions.assertEquals(Quarter.Q2, quarter);

        dateTime = new DateTime("2017-07-05 12:34:23", Formatter.NORM_DATETIME_FORMAT);
        quarter = dateTime.quarterEnum();
        Assertions.assertEquals(Quarter.Q3, quarter);

        dateTime = new DateTime("2017-10-05 12:34:23", Formatter.NORM_DATETIME_FORMAT);
        quarter = dateTime.quarterEnum();
        Assertions.assertEquals(Quarter.Q4, quarter);

        // 精确到毫秒
        final DateTime beginTime = new DateTime("2017-10-01 00:00:00.000", Formatter.NORM_DATETIME_MS_FORMAT);
        dateTime = DateKit.beginOfQuarter(dateTime);
        Assertions.assertEquals(beginTime, dateTime);

        // 精确到毫秒
        final DateTime endTime = new DateTime("2017-12-31 23:59:59.999", Formatter.NORM_DATETIME_MS_FORMAT);
    ...
    public void mutableTest() {
        ...
        // 默认情况下DateTime为可变对象
        DateTime offsite = dateTime.offset(Various.YEAR, 0);
        Assertions.assertSame(offsite, dateTime);

        // 设置为不可变对象后变动将返回新对象
        dateTime.setMutable(false);
        offsite = dateTime.offset(Various.YEAR, 0);
    ...
    public void toStringTest2() {
        ...
        String dateStr = dateTime.toString(Fields.ISO8601_WITH_ZONE_OFFSET);
        Assertions.assertEquals("2017-01-05T12:34:23+0800", dateStr);

        dateStr = dateTime.toString(Fields.ISO8601_WITH_XXX_OFFSET);
    ...
    public void monthTest() {
        ...
        final int month = DateKit.parse("2017-07-01").month();
        Assertions.assertEquals(6, month);
    }

    @Test
    public void weekOfYearTest() {
        final DateTime date = DateKit.parse("2016-12-27");
        //noinspection ConstantConditions
    ...
    public void ofTest() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            ...
            new DateTime(a, Formatter.NORM_DATETIME_FORMAT, false);
        });
    }
