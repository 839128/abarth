...
public class UrlBuilderTest {
    ...
    public void buildTest() {
        ...
        final String buildUrl = builder.setHost("www.miaixz.org").build();

        Assertions.assertEquals("http://www.miaixz.org/", buildUrl);
    ...
    public void buildTest2() {
        // path中的+不做处理
        final String buildUrl = UrlBuilder.ofHttp("http://www.miaixz.org/+8618888888888", Charset.UTF_8).build();
        Assertions.assertEquals("http://www.miaixz.org/+8618888888888", buildUrl);
    }
    ...
    public void testHost() {
        final String buildUrl = UrlBuilder.of()
                .setScheme("https")
                .setHost("www.miaixz.org").build();
        Assertions.assertEquals("https://www.miaixz.org/", buildUrl);
    }
    ...
    public void testHostPort() {
        final String buildUrl = UrlBuilder.of()
                .setScheme("https")
                .setHost("www.miaixz.org")
                .setPort(8080)
                .build();
        Assertions.assertEquals("https://www.miaixz.org:8080/", buildUrl);
    }
    ...
    public void testPathAndQuery() {
        ...
        Assertions.assertEquals("https://www.miaixz.org/aaa/bbb?ie=UTF-8&wd=test", buildUrl);
    }
    ...
    public void testQueryWithChinese() {
        ...
        Assertions.assertEquals("https://www.miaixz.org/aaa/bbb?ie=UTF-8&wd=%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testMultiQueryWithChinese() {
        ...
        Assertions.assertEquals("https://www.miaixz.org/s?ie=UTF-8&ie=GBK&wd=%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testFragment() {
        ...
        Assertions.assertEquals("https://www.miaixz.org/#abc", buildUrl);
    }
    ...
    public void testChineseFragment() {
        ...
        Assertions.assertEquals("https://www.miaixz.org/#%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testChineseFragmentWithPath() {
        final String buildUrl = new UrlBuilder()
                ...
                .addPath("/s")
                .setFragment("测试").build();
        Assertions.assertEquals("https://www.miaixz.org/s#%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testChineseFragmentWithPathAndQuery() {
        final String buildUrl = new UrlBuilder()
                ...
                .addQuery("wd", "test")
                .setFragment("测试").build();
        Assertions.assertEquals("https://www.miaixz.org/s?wd=test#%E6%B5%8B%E8%AF%95", buildUrl);
    }

    @Test
    public void ofTest() {
        final UrlBuilder builder = UrlBuilder.of("http://www.miaixz.org/aaa/bbb/?a=1&b=2#frag1", Charset.UTF_8);
        Assertions.assertEquals("http", builder.getScheme());
        Assertions.assertEquals("www.miaixz.org", builder.getHost());
    ...
    public void ofNullQueryTest() {
        final UrlBuilder builder = UrlBuilder.of("http://www.miaixz.org/aaa/bbb", Charset.UTF_8);
    ...
    public void ofWithChineseTest() {
        final UrlBuilder builder = UrlBuilder.ofHttp("www.miaixz.org/aaa/bbb/?a=张三&b=%e6%9d%8e%e5%9b%9b#frag1", Charset.UTF_8);
        Assertions.assertEquals("http", builder.getScheme());
        Assertions.assertEquals("www.miaixz.org", builder.getHost());
    ...
    public void ofSpecialTest() {
        ...
        final UrlBuilder builder = UrlBuilder.ofHttp(" www.miaixz.org/aaa/bbb/?a=张三&b=%%e5%9b%9b#frag1", Charset.UTF_8);
        Assertions.assertEquals("http", builder.getScheme());
        Assertions.assertEquals("www.miaixz.org", builder.getHost());
    ...
    public void weixinUrlTest() {
        ...
        final UrlBuilder builder = UrlBuilder.ofHttp(urlStr, Charset.UTF_8);
        // 原URL中的&amp;替换为&
    ...
    public void endWithSlashTest() {
        // 原URL中以/结尾，则这个规则需保留
        final String today = DateKit.now().toString("yyyyMMdd");
        final String getWorkDayUrl = "https://tool.bitefu.net/jiari/?info=1&d=" + today;
        final UrlBuilder builder = UrlBuilder.ofHttp(getWorkDayUrl, Charset.UTF_8);
        Assertions.assertEquals(getWorkDayUrl, builder.toString());
    }

    @Test
    public void blankEncodeTest() {
        final UrlBuilder urlBuilder = UrlBuilder.ofHttp("http://a.com/aaa bbb.html", Charset.UTF_8);
        Assertions.assertEquals("http://a.com/aaa%20bbb.html", urlBuilder.toString());
    }

    @Test
    public void dotEncodeTest() {
        final UrlBuilder urlBuilder = UrlBuilder.ofHttp("http://xtbgyy.digitalgd.com.cn/ebus/../../..", Charset.UTF_8);
    ...
    public void multiSlashTest() {
        // 某些URL中有多个斜杠，此为合法路径
        final UrlBuilder urlBuilder = UrlBuilder.ofHttp("https://www.miaixz.org//file/test.jpg", Charset.UTF_8);
        Assertions.assertEquals("https://www.miaixz.org//file/test.jpg", urlBuilder.toString());
    }
    ...
    public void testEncodeInQuery() {
        ...
        final UrlBuilder urlBuilder = UrlBuilder.of(webUrl, StandardCharsets.UTF_8);
        Assertions.assertEquals("a=123&b=4?6&c=789", urlBuilder.getQuerys());
    }
    ...
    public void encodePathTest() {
        ...
        final UrlBuilder urlBuilder = UrlBuilder.ofHttp(urlStr, Charset.UTF_8);
    ...
    public void encodePathTest2() {
        ...
        final String urlStr = "https://www.miaixz.org/aa/bb/Pre-K,Kindergarten,First,Second,Third,Fourth,Fifth/Page:3";
        final UrlBuilder urlBuilder = UrlBuilder.ofHttp(urlStr, Charset.UTF_8);
        Assertions.assertEquals(urlStr, urlBuilder.toString());
    }
    ...
    public void fragmentEncodeTest() {
        ...
        final String url = "https://www.miaixz.org/docs/#/?id=简介";
        UrlBuilder urlBuilder = UrlBuilder.ofHttp(url);
        Assertions.assertEquals("https://www.miaixz.org/docs/#/?id=%E7%AE%80%E4%BB%8B", urlBuilder.toString());
    ...
    public void fragmentTest() {
        final String url = "https://www.miaixz.org/#/a/b?timestamp=1640391380204";
        final UrlBuilder builder = UrlBuilder.ofHttp(url);
    ...
    public void fragmentAppendParamTest() {
        final String url = "https://www.miaixz.org/#/a/b";
        final UrlBuilder builder = UrlBuilder.ofHttp(url);
        builder.setFragment(builder.getFragment() + "?timestamp=1640391380204");
        Assertions.assertEquals("https://www.miaixz.org/#/a/b?timestamp=1640391380204", builder.toString());
    }
    ...
    public void issuesTest() {
        final String url = "https://www.miaixz.org/v1/104303371/messages:send";
        final String build = UrlBuilder.of(url).build();
        Assertions.assertEquals(url, build);
    }
    ...
    public void issuesTest1() {
        final String url = "http://www.miaixz.org/2022/03/09/123.zip?Expires=1648704684&OSSAccessKeyId=LTAI4FncgaVtwZGBnYHHi8ox&Signature=%2BK%2B%3D";
    ...
    public void issueTest3() {
        // 如果用户已经做了%编码，不应该重复编码
        final String url = "https://www.miaixz.org/v1.0?privateNum=%2B8616512884988";
        final String s = UrlBuilder.of(url, null).setCharset(Charset.UTF_8).toString();
    ...
    public void issueTest1() {
        // &amp;自动转换为&
        final String url = "https://www.miaixz.org/a.mp3?Expires=1652423884&amp;key=JMv2rKNc7Pz&amp;sign=12zva00BpVqgZcX1wcb%2BrmN7H3E%3D";
        final UrlBuilder of = UrlBuilder.of(url, null);
        Assertions.assertEquals(url.replace("&amp;", "&"), of.toString());
    }

    @Test
    public void issuesTest3() throws URISyntaxException {
    ...
    public void ofHttpTest() {
        UrlBuilder ofHttp = UrlBuilder.ofHttp("http://www.miaixz.org");
        Assertions.assertEquals("http://www.miaixz.org", ofHttp.toString());

        ofHttp = UrlBuilder.ofHttp("https://www.miaixz.org");
        Assertions.assertEquals("https://www.miaixz.org", ofHttp.toString());

        ofHttp = UrlBuilder.ofHttp("www.miaixz.org");
        Assertions.assertEquals("http://www.miaixz.org", ofHttp.toString());

        ofHttp = UrlBuilder.ofHttp("www.miaixz.org?old=http://aaa");
        Assertions.assertEquals("http://www.miaixz.org?old=http://aaa", ofHttp.toString());
    }
