...
public class ValidatorTest {
    ...
    @Test
    void issueTest() {
        final boolean ret = Pattern.EMAIL_PATTERN.matcher(StringKit.repeat("bus\\\"", 1000)).matches();
    ...
    public void isMatchTest() {
        ...
        Assertions.assertTrue(Validator.isMatchRegex(Pattern.URL_HTTP_PATTERN, url));
    ...
    public void isUUIDTest() {
        Assertions.assertTrue(Validator.isUUID(ID.randomUUID()));
        Assertions.assertTrue(Validator.isUUID(ID.fastSimpleUUID()));

        Assertions.assertTrue(Validator.isUUID(ID.randomUUID().toUpperCase()));
        Assertions.assertTrue(Validator.isUUID(ID.fastSimpleUUID().toUpperCase()));
    }
    ...
    public void isUrlTest() {
        ...
        Assertions.assertTrue(Validator.isMatchRegex(Pattern.URL_PATTERN, content));
        Assertions.assertTrue(Validator.isMatchRegex(Pattern.URL_PATTERN, content));
    }

    @Test
    public void validateBetweenTest() {
        final Date value = DateKit.parse("2022-08-09 21:22:00");
        final Date start = DateKit.parse("2022-08-01 21:22:00");
        final Date end = DateKit.parse("2022-09-09 21:22:00");

        Validator.validateBetween(value, start, end, "您选择的日期超出规定范围!");
        Assertions.assertTrue(true);

        final Date value2 = DateKit.parse("2023-08-09 21:22:00");
    ...
    public void validateByteLengthTest() {
        final String s1 = "abc";
        final int len1 = StringKit.byteLength(s1, Charset.UTF_8);
        Assertions.assertEquals(len1, 3);

        final String s2 = "我ab";
        final int len2 = StringKit.byteLength(s2, Charset.UTF_8);
    ...
    @Test
    void issueTest1() {
        Validator.validateEmail("test@qq.com", "test");
    }
