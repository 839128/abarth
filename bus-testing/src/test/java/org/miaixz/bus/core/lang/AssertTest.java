...
public class AssertTest {
    ...
    public void notEmptyForCollectionTest() {
        // 虽然包含空字符串或者null，但是这大概数组由于有元素，则认定为非empty
        List<String> a = ListKit.of("");
        List<String> s = Assert.notEmpty(a);
        Assertions.assertSame(a, s);

        a = ListKit.of((String) null);
        s = Assert.notEmpty(a);
        Assertions.assertSame(a, s);
    }
    ...
    public void notEmptyForMapTest() {
        // 虽然包含空字符串或者null，但是这大概数组由于有元素，则认定为非empty
        Map<String, String> a = MapKit.of("", "");
        Map<String, String> s = Assert.notEmpty(a);
        Assertions.assertSame(a, s);

        a = MapKit.of(null, null);
        s = Assert.notEmpty(a);
        Assertions.assertSame(a, s);
    }
    ...
    public void equalsTest() {
        ...
        Assert.equals(a, b, () -> new RuntimeException(StringKit.format("{}和{}不相等", a, b)));
    }
    ...
    public void notEqualsTest() {
        final String c = null;
        final String d = "null";
        Assert.notEquals(c, d, () -> new RuntimeException(StringKit.format("{}和{}相等", c, d)));
