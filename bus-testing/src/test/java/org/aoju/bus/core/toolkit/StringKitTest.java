...
public class StringKitTest {
    ...
    public void isBlankTest() {
        String blank = "	  　";
        Assert.assertTrue(StringKit.isBlank(blank));
    }
    ...
    public void stripTest() {
        ...
        Assert.assertEquals("", StringKit.strip("a", "a"));
        Assert.assertEquals("", StringKit.strip("a", "a", "b"));
    }
    ...
    public void indexOfIgnoreCaseTest() {
        Assert.assertEquals(-1, StringKit.indexOfIgnoreCase(null, "balabala", 0));
        Assert.assertEquals(-1, StringKit.indexOfIgnoreCase("balabala", null, 0));
        Assert.assertEquals(0, StringKit.indexOfIgnoreCase("", "", 0));
        Assert.assertEquals(0, StringKit.indexOfIgnoreCase("aabaabaa", "A", 0));
        Assert.assertEquals(2, StringKit.indexOfIgnoreCase("aabaabaa", "B", 0));
        Assert.assertEquals(1, StringKit.indexOfIgnoreCase("aabaabaa", "AB", 0));
        Assert.assertEquals(5, StringKit.indexOfIgnoreCase("aabaabaa", "B", 3));
        Assert.assertEquals(-1, StringKit.indexOfIgnoreCase("aabaabaa", "B", 9));
        Assert.assertEquals(2, StringKit.indexOfIgnoreCase("aabaabaa", "B", -1));
        Assert.assertEquals(2, StringKit.indexOfIgnoreCase("aabaabaa", "", 2));
        Assert.assertEquals(-1, StringKit.indexOfIgnoreCase("abc", "", 9));
    }
    ...
    public void lastIndexOfIgnoreCaseTest() {
        Assert.assertEquals(-1, StringKit.lastIndexOfIgnoreCase(null, "balabala", 0));
        Assert.assertEquals(-1, StringKit.lastIndexOfIgnoreCase("balabala", null));
        Assert.assertEquals(0, StringKit.lastIndexOfIgnoreCase("", ""));
        Assert.assertEquals(7, StringKit.lastIndexOfIgnoreCase("aabaabaa", "A"));
        Assert.assertEquals(5, StringKit.lastIndexOfIgnoreCase("aabaabaa", "B"));
        Assert.assertEquals(4, StringKit.lastIndexOfIgnoreCase("aabaabaa", "AB"));
        Assert.assertEquals(2, StringKit.lastIndexOfIgnoreCase("aabaabaa", "B", 3));
        Assert.assertEquals(5, StringKit.lastIndexOfIgnoreCase("aabaabaa", "B", 9));
        Assert.assertEquals(-1, StringKit.lastIndexOfIgnoreCase("aabaabaa", "B", -1));
        Assert.assertEquals(2, StringKit.lastIndexOfIgnoreCase("aabaabaa", "", 2));
        Assert.assertEquals(3, StringKit.lastIndexOfIgnoreCase("abc", "", 9));
    }
    ...
    public void removePrefixIgnorecaseTest() {
        String a = "aaabbb";
        String prefix = "aaa";
        Assert.assertEquals("bbb", StringKit.removePrefixIgnoreCase(a, prefix));

        prefix = "AAA";
        Assert.assertEquals("bbb", StringKit.removePrefixIgnoreCase(a, prefix));

        prefix = "AAABBB";
        Assert.assertEquals("", StringKit.removePrefixIgnoreCase(a, prefix));
    }
    ...
    public void centerTest() {
        Assert.assertNull(StringKit.center(null, 10));
        Assert.assertEquals("    ", StringKit.center("", 4));
        Assert.assertEquals("ab", StringKit.center("ab", -1));
        Assert.assertEquals(" ab ", StringKit.center("ab", 4));
        Assert.assertEquals("abcd", StringKit.center("abcd", 2));
        Assert.assertEquals(" a  ", StringKit.center("a", 4));
    }

    @Test
    public void padPreTest() {
        Assert.assertNull(StringKit.padPre(null, 10, ' '));
        Assert.assertEquals("001", StringKit.padPre("1", 3, '0'));
        Assert.assertEquals("12", StringKit.padPre("123", 2, '0'));

        Assert.assertNull(StringKit.padPre(null, 10, "AA"));
        Assert.assertEquals("AB1", StringKit.padPre("1", 3, "ABC"));
        Assert.assertEquals("12", StringKit.padPre("123", 2, "ABC"));
    }

    @Test
    public void padAfterTest() {
        Assert.assertNull(StringKit.padAfter(null, 10, ' '));
        Assert.assertEquals("100", StringKit.padAfter("1", 3, '0'));
        Assert.assertEquals("23", StringKit.padAfter("123", 2, '0'));

        Assert.assertNull(StringKit.padAfter(null, 10, "ABC"));
        Assert.assertEquals("1AB", StringKit.padAfter("1", 3, "ABC"));
        Assert.assertEquals("23", StringKit.padAfter("123", 2, "ABC"));
    }
