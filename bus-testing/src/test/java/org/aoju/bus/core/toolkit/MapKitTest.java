...
public class MapKitTest {
    ...
    public void filterTest() {
        Map<String, String> map = MapKit.newHashMap();
        map.put("a", "1");
        map.put("b", "2");
        map.put("c", "3");
        map.put("d", "4");
    ...
    public void filterForEditorTest() {
        ...
        Map<String, String> map2 = MapKit.filter(map, (Editor<Entry<String, String>>) t -> {
            // 修改每个值使之*10
    ...
    public void toObjectArrayTest() {
        Map<String, String> map = MapKit.newHashMap(true);
        map.put("a", "1");
        map.put("b", "2");
        map.put("c", "3");
        map.put("d", "4");
