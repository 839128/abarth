...
public class ValidatorTest {
    ...
    public void isMatchTest() {
        ...
        Assert.assertTrue(Validator.isMatchRegex(RegEx.URL_HTTP, url));
    ...
    public void isPasswordTest() {
        Assert.assertFalse(Validator.isPassword("12345678d"));
        Assert.assertTrue(Validator.isPassword("12345678d", true));
        Assert.assertTrue(Validator.isPassword("12345678d#"));
    }
