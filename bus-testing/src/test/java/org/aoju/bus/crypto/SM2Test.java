...
public class SM2Test {
    ...
    public void KeyPairOIDTest() {
        ...
        KeyPair pair = Builder.generateKeyPair("SM2");
        Assert.assertTrue(HexKit.encodeHexStr(pair.getPrivate().getEncoded()).toUpperCase().contains(OID));
        Assert.assertTrue(HexKit.encodeHexStr(pair.getPublic().getEncoded()).toUpperCase().contains(OID));
    }
